...
We form words by concatenating tape symbols of the support and writing the head's state before the bit it's on. For instance, the word associated to the tape depicted in Figure~\ref{fig:far_scan} reads \texttt{00A001100}.}
