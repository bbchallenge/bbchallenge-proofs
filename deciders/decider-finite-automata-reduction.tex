...
\ts{A dual idea} has been explored by other authors under the name Closed Tape Languages (CTL) as described in S. Ligocki's blog \cite{ShawnCTL} and credited to H. Marxen in collaboration with J. Buntrock.
...
\begin{enumerate}
  \item $C$ contains the all-0 initial configuration\footnote{
          ...
          \tss{In that case, the set of ancestor configurations to those in $C$ meets the strict definition; noting this abstractly may be more convenient than constructing this set.}{}
        }
