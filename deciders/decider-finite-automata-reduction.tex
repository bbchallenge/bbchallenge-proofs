...
then set entries to 1 as these 4 inequalities demand until a fixed point is reached \ts{-- inequality \ref{far-cond-left}' is the only one that does not have a constant right-hand side and which requires an iterative process to reach the solution}.
