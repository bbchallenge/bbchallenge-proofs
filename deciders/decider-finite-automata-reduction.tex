...
\begin{enumerate}
  ...
  \item Row vectors of matrices $M_f$ (with $f\in\{A,\ldots,E\}$) are the basis row vectors $e_0,\, \dots,\, e_{5l} \in \M_{1,d}$ where basis vector $e_i$ has its $i^\text{th}$ entry set to 1 and the other entries set to 0.\label{pt:basis}
