...
\ts{The remaining conditions of Theorem \ref{far-main-theorem} are \eqref{far-cond-trailing-0}, \eqref{far-cond-ass-accepted} and \eqref{far-cond-reject-start}, they respectively translate to:
  \begin{align}
    a R_0 = a
     &
    \tag{\ref{far-cond-trailing-0}'}
