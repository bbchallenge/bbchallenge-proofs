...
One important aspect of the technique is that, given a Turing machine and its constructed NFA---if found---it is a \jbs{\textbf{simple}}{computationally simple} task to verify that the NFA's language does indeed recognise \jbs{at least }all eventually-halting configurations of the machine.
