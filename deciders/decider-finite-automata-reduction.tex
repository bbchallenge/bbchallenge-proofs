...
that will describe \ts{the support of the configuration (i.e.} any segment of the machine's tape that contains at least all non-zero cells\ts{)}
and write the head's state before the bit it's on.
