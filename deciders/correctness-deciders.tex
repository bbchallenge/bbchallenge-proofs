...
symbols. Thus, we write $l <_q r$ to mean that the head is at the rightmost symbol
of $l$, and $l >_q r$ to mean that the head is at the leftmost symbol of $r$.
For example, $0^\infty\; [1]_A\; 0^\infty$ can be written as
$0^\infty\; 1 <_A 0^\infty$ or $0^\infty >_A 1\; 0^\infty$.
