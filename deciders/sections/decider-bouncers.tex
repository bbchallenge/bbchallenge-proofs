...
\begin{example}
    Using the machine of Example~\ref{ex:bouncer88427177} used in the previous section, with formula tape $f=0^\infty (111)1110(11)00\rhead{\text{D}}0^\infty$, we have:

    \begin{align*}
        0^\infty \rhead{\text{A}} 0^\infty & \vdash^{64} 0^\infty 111\; 1110\; 11\; 00 \rhead{\text{D}} 0^\infty                                  & g(0) = 64,\; l_{64} = 11   \\
                                           & \vdash^{41}   0^\infty111\; 111\; 1110\; 11\; 11\; 00 \rhead{\text{D}}0^\infty                       & g(1) = 105,\; l_{105} = 16 \\
                                           & \vdash^{41}   0^\infty111\; 111\; 111\; 1110\; 11\; 11\; 11\; 00 \rhead{\text{D}}0^\infty            & g(2) = 105,\; l_{105} = 21 \\
                                           & \vdash^{41}   0^\infty111\; 111\; 111\; 111\; 1110\; 11\; 11\; 11\; 11\; 00 \rhead{\text{D}}0^\infty & g(3) = 105,\; l_{105} = 26 \\
    \end{align*}
