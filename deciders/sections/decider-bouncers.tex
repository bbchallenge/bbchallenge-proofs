...
\begin{proof}
    ...
    Applying case (1) or (2) to all repeaters of $\mathcal{A}_r(f)$ that are separated by an empty wall, and we get a right-aligned transformation of $f$ with nonempty intermediary walls, as needed.
