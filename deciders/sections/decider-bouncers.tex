...
\paragraph{Acknowledgement.}  Sincere thanks to Tony Guilfoyle who initially implemented a decider for bouncers\footnote{See: \url{https://github.com/TonyGuil/bbchallenge/tree/main/Bouncers}.}. Many thanks to savask who built and implemented\footnote{See: \url{https://gist.github.com/savask/888aa5e058559c972413790c29d7ad72}.} a theory upon Tony's ideas, wrote the initial version of this section and was closely involved in the process of building this text.
Others have contributed to this method by producing alternative implementations (see Section~\ref{sec:bouncers-implem}) or discussing and writing the formal proof presented here: Iijil, mei, Tristan Stérin (cosmo).
...
\end{proof}
\begin{remark}[Minimal formula tapes]
...
\begin{algorithm}[h!]
    ...
    \begin{algorithmic}[1]
        ...
        \For{\textbf{uint} i, \textbf{Tape} tape4 \textbf{in} record\_breaking\_tapes[head][4:].\textbf{enumerate}()}

        \For{\textbf{Tape} tape3 \textbf{in} record\_breaking\_tapes[head][4:][:i]}
