...
\begin{theorem}
    ...
    \end{align*}
    Then Algorithm~\ref{alg:greedy-formula-tape-fitting} does not raise failure and returns the formula tape $\mathcal{A}(f)$ with $\mathcal{S}(f) = w_1 r_1 (r_1) \dots w_m r_m (r_m) w_{m+1}$.
