...
\begin{theorem}[Greedy formula tape fitting]\label{th:greedy}
    Let there be 3 words $t_0, t_1, t_2 \in \Sigma^*$, and an integer $m\in\N$ and $w_1, \dots w_{m+1} \in \Sigma^*$ such that $w_2,\dots, w_m\in\Sigma^*$ and $r_1, \dots, r_m \in\Sigma^+$ such that:
    \begin{align*}
