        ...
        \begin{algorithmic}[1]
          ...
          \State \textbf{struct} ValueAndLastTimeVisited \{
            ...
            \State \}
                ...
                \If{{\sc check-records}(currConfiguration, recordHoldingConfigurations[recordSide], recordSide)}
...
\begin{definition}[Record-holding configurations]\normalfont
...
\begin{definition}[Distance $L$ between record-holding configurations]\label{def:distL}\normalfont
